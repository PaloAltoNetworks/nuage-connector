...
class NuageAPI(object):
  ...
  def __retrieve_apikey(self):
    ...
    req = urllib2.Request(self.vsdurl+"/nuage/api/v4_0/me", headers=headers)
  ...
  def api_call(self, url, timeout=None):
    ...
    req = urllib2.Request(self.vsdurl+"/nuage/api/v4_0"+url, headers=headers)
    f = urllib2.urlopen(req, **kwargs)
...
if __name__ == "__main__":
  ...
  n = NuageAPI("54.67.115.158:8443", "csproot", "poi@UYT098", "csp")
